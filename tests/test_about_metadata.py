...
REPOSITORY = "https://github.com/Linxira-OS/linxira-hardware-driver-manager"


class AboutMetadataTests(unittest.TestCase):
    def test_about_and_metadata_urls_match(self):
        about = (ROOT / "src/linxira_hardware_driver_manager/about.py").read_text(encoding="utf-8")
        ui = (ROOT / "src/linxira_hardware_driver_manager/ui.py").read_text(encoding="utf-8")
        ...
        component = ET.parse(ROOT / "data/org.linxira.HardwareDriverManager.metainfo.xml").getroot()
